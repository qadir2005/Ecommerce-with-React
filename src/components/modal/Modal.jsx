        ...
        <>
            <div className="  text-center rounded-lg text-white font-bold">
                <button
                    type="button"
                    onClick={openModal}
                    className="w-full  bg-[#C8A165] py-2 text-center rounded-lg text-white font-bold "
                >
                    Buy Now
                </button>
            </div>
            ...
            <Transition appear show={isOpen} as={Fragment}>
                <Dialog as="div" className="relative z-10" onClose={closeModal}>
                    <Transition.Child
                        ...
                        leaveTo="opacity-0"
                    >
                        <div className="fixed inset-0 bg-[#E4E0E1] bg-opacity-25" />
                    </Transition.Child>
                                        ...
                                        <div className="flex flex-col items-center justify-center py-8 mx-auto  lg:py-0">
                                            ...
                                            <div className="w-full  rounded-lg md:mt-0 sm:max-w-md xl:p-0 ">
                                                ...
                                                <form className="space-y-4 md:space-y-6" action="#">
                                                    ...
                                                    <button onClick={()=>{buyNow(); closeModal()}} type="button" className="focus:outline-none w-full text-white bg-[#C8A165] hover:bg-[#C8A166]  outline-0 font-medium rounded-lg text-sm px-5 py-2.5 ">Order Now</button>
